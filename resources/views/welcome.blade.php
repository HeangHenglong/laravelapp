...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-light">
        <div class="container">
          <a class="navbar-brand text-uppercase" href="{{'welcome'}}">
            <strong><i class="bi bi-person-lines-fill me-1"></i>Heng</strong> Long
          </a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex" role="search">
              <ul class="navbar-nav ml-auto">
                <li class="nav-item mx-1"><a href="{{'login'}}" class="btn btn-outline-secondary">Login</a></li>
                <li class="nav-item mx-1"><a href="{{'register'}}" class="btn btn-outline-primary">Register</a></li>
              </ul>
            </form>
          </div>
        </div>
    ...
    <div class="py-5 bg-white">
        <div class="px-4 my-5 text-center">
            <h1 class="display-5 fw-bold mt-4">Heng long</h1>
            <div class="col-lg-6 mx-auto">
                <p class="lead mb-4">Contact App gives you everything you need to organize your contacts easily.</p>
                <div class="d-flex justify-content-sm-center">
                    <a href="{{'register'}}" class="btn btn-primary mx-2">Sign up</a>
                    <a href="{{'login'}}" class="btn btn-outline-secondary mx-2">Sign in</a>
                </div>
            </div>
        </div>
    </div>
